    ...
    <style>
        * {
        ...
        .wedding_cloth {
            height: 70%;
            width: 16%;
            background-image: url("weddingcloth.png");
            background-repeat: no-repeat;
            object-fit: cover;
            background-size: cover;
        }
        ...
        .jewellery {
            height: 70%;
            width: 16%;
            background-image: url("jewellery.png");
            background-repeat: no-repeat;
            object-fit: cover;
            background-size: cover;
        }
        ...
        .assesory {
            height: 70%;
            width: 16%;
            background-image: url("assesory.png");
            background-repeat: no-repeat;
            object-fit: cover;
            background-size: cover;
        }
        ...
        <div class="third_container">
            ...
            <div class="store_container">
                ...
                <div class="store_image">
                    <img src="mumbai.svg" alt="" class="store_img">
                    <img src="ahmedabad.svg" alt="">
